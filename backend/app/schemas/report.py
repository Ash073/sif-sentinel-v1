...
class ReportUpdate(ORMModel):
    # A report's lifecycle is exclusively controlled by analysis and review.
    # Forbid unknown fields so a client cannot silently submit `status` and
    # mistake a rejected lifecycle transition for a successful update.
