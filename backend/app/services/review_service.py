...
def _to_queue_item(review: Review, report: Report, analysis: ReportAnalysis | None, pending: bool) -> ReviewQueueItem:
    ...
    return ReviewQueueItem(
        ...
        original_sif_level=analysis.sif_level if analysis else None,
        original_activity=analysis.activity if analysis else None,
        original_hazard=analysis.hazard if analysis else None,
        original_barrier=analysis.barrier if analysis else None,
        original_barrier_status=analysis.barrier_status if analysis else None,
        original_barrier_failure=analysis.barrier_failure if analysis else None,
        original_life_saving_rule=analysis.life_saving_rule if analysis else None,
